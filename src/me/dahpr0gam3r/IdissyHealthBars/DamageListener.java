...
import me.dahpr0gam3r.IdissyHealthBars.utils.MobBarsUtils;
	...
	private static void showMobHealthBar (final LivingEntity mob) {
		...
		scheduler.scheduleSyncDelayedTask(plugin, new Runnable() {
	    	  public void run() {
			      ...
			      {
			    	  mob.setCustomName(ChatColor.translateAlternateColorCodes('&',"&r"  + barArray[Utils.roundUpPositiveWithMax(((health/max) * 20.0), 20)]));
